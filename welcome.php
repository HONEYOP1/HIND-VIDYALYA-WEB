    ...
    <header>
        ...
        <nav class="navbar">
          ...
          <a href="./img gallery/index.html" target="_blank">Gallery</a>
            <a href="#doctor">Books</a>
          <a href="https://www.youtube.com/channel/UCoATVCn7bLEJVP91oHBEvhg" target="_blank">Blog</a>
          <a href="contact-form/index.php"><i class="fa fa-phone" aria-hidden="true"></i></a>
